...
$extraInfo['lang']                 = 'en';
$track = $track->createTracking('sf-express','959194122622',$extraInfo);

//4 List all trackings (列出多个物流信息)
//$track = $track->getTrackingsList($numbers = "959194122622",$orders = "",$page = 1,$limit = 100,$createdAtMin = 0,$createdAtMax = 0,$update_time_min = 0,$update_time_max = 0,$order_created_time_min = 0,$order_created_time_max = 0,$lang = "en");

//5 Get tracking results of a single tracking (列出单个运单号物流信息)
//$track = $track->getSingleTrackingResult("sf-express","959194122622",'en');

//6 create muti tracking number (创建多个运单号)
//$items = array(
//    array(
//        'tracking_number' => '959194122622',
...
//$extraInfo['destination_code'] = 'US';
//$extraInfo['status']       = '7';
//$track = $track->updateTrackingItem('sf-express','959194122622',$extraInfo);

//8 Delete a tracking item (删除单个运单号)
//$track = $track->deleteTrackingItem('sf-express','959194122622');

//9 Get realtime tracking results of a single tracking (获取单个运单号实时物流信息)
// $track = $track->getRealtimeTrackingResults("sf-express","959194122622",array("lang"=>'en'));

//10 Modify courier code (修改运输商简码)
//$r = $track->updateCarrierCode("959194122622","sf-express","china-ems");
...
//$date = array();
//$data[] = array("tracking_number"=>"959194122622","carrier_code"=>"sf-express");
...
//$data = array();
//$data[] = array("original"=>"CN","destination"=>"US","carrier_code"=>"sf-express");
